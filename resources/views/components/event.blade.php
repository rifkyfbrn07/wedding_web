...
<section id="event" aria-label="Rangkaian Acara">
    ...
    <div class="section-eyebrow gsap-fade-up">— Rangkaian Acara —</div>
    <h2 class="section-title gsap-fade-up">Hari Pernikahan</h2>
    ...
    <div class="event-cards">
        ...
        <article class="event-card" aria-label="Akad Nikah">
            ...
            <div class="event-detail">
                ...
                <span>
                    <strong style="color:var(--color-beige);display:block;">Minggu, 09 Agustus 2026</strong>
        ...
        <article class="event-card" aria-label="Resepsi">
            ...
            <div class="event-type">Resepsi Pernikahan</div>
