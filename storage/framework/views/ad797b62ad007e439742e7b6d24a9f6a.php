    ...
    <div class="rsvp-wishes-container">
        ...
        <div class="rsvp-wishes-left">
            ...
            <div class="rsvp-form-wrapper" style="margin-top: 0; max-width: 100%;">
                <form
                    id="rsvp-form"
                    action="<?php echo e(route('rsvp.store')); ?>"
                    method="POST"
                    novalidate
                ...
                >
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($guest) && $guest): ?>
                    ...
                    <div class="form-group">
                        ...
                        <input
                            ...
                            value="<?php echo e(isset($guest) && $guest ? $guest->name : ''); ?>"
                            required
                            autocomplete="name"
                        >
                    </div>
...
</section><?php /**PATH C:\Users\pcbaz\Documents\rifky\wedding_web\resources\views/components/rsvp.blade.php ENDPATH**/ ?>