<section id="hero" aria-label="Hero">
    ...
    <div class="hero-content">
        ...
        <p class="hero-eyebrow" aria-hidden="true">
            <span data-i18n-lang="id">Walimatul 'Urs</span>
            <span data-i18n-lang="en" class="i18n-hidden">Walimatul 'Urs</span>
        </p>
        ...
        <div class="hero-date-tag" aria-hidden="true">
            <?php echo e($invitation->akad_start_at->translatedFormat('l, d F Y')); ?>
...
</section><?php /**PATH C:\Users\pcbaz\Documents\rifky\wedding_web\resources\views/components/hero.blade.php ENDPATH**/ ?>